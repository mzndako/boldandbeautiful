...
| -------------------------------------------------------------------*/
            ...
            $config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] ."/myschool/". $config['img_path']; // Physical path. [Usually works fine like this]
    
//            if($_SERVER['SERVER_ADDR'] != "127.0.0.1"){
//                   $config['upload_path'] = "http://www.quicksms1.com/reseller/uploads";
//            }
