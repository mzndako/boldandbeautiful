	...
	<div class="login-header login-caret">
		...
		<div class="login-content" style="width:100%;">
			...
			<a href="<?php echo base_url();?>" class="logo">
				<img src="<?php echo $this->c_->get_image_url('',-1,'logo');?>" height="150" alt="" />
			</a>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="form-login-error">
				<h3>Invalid login</h3>
				<p>Please enter correct email (or phone number) and password!</p>
			</div>
			...
			<form method="post" role="form" id="form_login">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="email" id="email" placeholder="Email Or Phone Number" autocomplete="on" data-mask="email" />
					</div>
			...
			<div class="login-bottom-links">
				...
				<a href="<?php echo base_url();?>?users/register_user" class="link">
