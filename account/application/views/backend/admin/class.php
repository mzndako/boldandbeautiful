                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo $this->crud_model->get_full_name($this->c_->get_where("teacher", array('teacher_id' => $row['teacher_id']        ))->row());?></td>
							<td>
                            <div class="btn-group">
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select placeholder="Select Teacher" name="teacher_id" class="form-control select2" style="width:100%;" required>

                                    	<?php 
										$teachers = $this->c_->get_where('teacher',array("is_academic"=>1))->result_array();
